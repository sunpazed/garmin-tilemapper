...
class BasicView extends Ui.WatchFace {
    ...
    function drawTime(targetDc,this_x,this_y) {
      ...
      f_hands = Ui.loadResource(Rez.Fonts.u200_dial);
      ...
      if (hour_is>=45 && hour_is<=59) {
        f_hands = Ui.loadResource(Rez.Fonts.u200_hand_45_59);
        current_hand = Ui.loadResource(Rez.JsonData.u200_hand_45_59_data);
        hr_is = hour_is - 45;
      }
      if (hour_is>=30 && hour_is<=44) {
        f_hands = Ui.loadResource(Rez.Fonts.u200_hand_30_44);
        current_hand = Ui.loadResource(Rez.JsonData.u200_hand_30_44_data);
        hr_is = hour_is - 30;
      }
      if (hour_is>=15 && hour_is<=29) {
        f_hands = Ui.loadResource(Rez.Fonts.u200_hand_15_29);
        current_hand = Ui.loadResource(Rez.JsonData.u200_hand_15_29_data);
        hr_is = hour_is - 15;
      }
      if (hour_is>=0 && hour_is<=14) {
        f_hands = Ui.loadResource(Rez.Fonts.u200_hand_0_14);
        current_hand = Ui.loadResource(Rez.JsonData.u200_hand_0_14_data);
        hr_is = hour_is;
      }
