...
class BasicView extends Ui.WatchFace {
    ...
    function drawTime(targetDc,this_x,this_y) {
      ...
      targetDc.setColor(0xffff00, Gfx.COLOR_TRANSPARENT);
      drawTiles(current_hand[hr_is+30],f_hands,targetDc,this_x,this_y);
      targetDc.setColor(0x000000, Gfx.COLOR_TRANSPARENT);
      ...
      if (minute>=45 && minute<=59) {
        f_hands = Ui.loadResource(Rez.Fonts.font_min_45_59);
        current_hand = Ui.loadResource(Rez.JsonData.font_min_45_59_data);
        min = minute - 45;
      }
      if (minute>=30 && minute<=44) {
        f_hands = Ui.loadResource(Rez.Fonts.font_min_30_44);
        current_hand = Ui.loadResource(Rez.JsonData.font_min_30_44_data);
        min = minute - 30;
      }
      if (minute>=15 && minute<=29) {
        f_hands = Ui.loadResource(Rez.Fonts.font_min_15_29);
        current_hand = Ui.loadResource(Rez.JsonData.font_min_15_29_data);
        min = minute - 15;
      }
      if (minute>=0 && minute<=14) {
        f_hands = Ui.loadResource(Rez.Fonts.font_min_0_14);
        current_hand = Ui.loadResource(Rez.JsonData.font_min_0_14_data);
        min = minute;
      }
      ...
      drawTiles(current_hand[min+30],f_hands,targetDc,this_x,this_y);
      targetDc.setColor(0x000000, Gfx.COLOR_TRANSPARENT);
